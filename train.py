...
# Now to increae the accuracy of the model, we'll perform Hyperparameter-tuning using grid search
param_grid = {
...
#Loading the scaler model for transformation on the new test data
